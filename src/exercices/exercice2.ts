...
const myExercise: Exercise = {
  ...
  steps: [
    ...
    {
      id: "step-4", number: 4, name: "Réglage du débit d'eau",
    ...
    },
    {
      ...
      action: { type: "inputChange", fieldId: "P1", expectedValue: true, 
      label: "Entrez 200 dans le champ de débit" },
    ...
    },
    {
      ...
      action: { type: "inputChange", fieldId: "H1", expectedValue: true, 
    ...
    },
    {
      ...
      action: { type: "inputChange", fieldId: "TT07", isDirectAnswer: true, expectedValue: "20", 
    ...
    },
    {
      ...
      action: { type: "inputChange", fieldId: "TT08", isDirectAnswer: true, expectedValue: "35", 
